...
<!-- start of jumbotron -->
     ...
     <section class = "aboutBox shadow-sm">
       <main>
      ...
      <h2 id="services">SERVICES</h2>
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <h4>Yellow Cab</h4>
            <p>Yellow cab is one original taxi cab companies. Debuting at a Paris theater, in the 1800s. Yellow Cab has since grown to encompass countries worldwide including Australia, Canada, India, Spain and the United States
              The Arizona Yellow Cab is available for transportation to major events, airport pick-ups, and rides to hotel and resorts. Since 1982 they have been dedicated to providing their customers with high-quality, easy transportation services. </p>
          </div>
          </div>
          <br><br>
